package com.sutrix.demon.core.helper;
...
public class MultifieldHelper {
    ...
    private int copies;
    private List<com.aem.geeks.core.helper.NastedHalper> bookEditons;
    ...
    public List<com.aem.geeks.core.helper.NastedHalper> getBookEditons() {
        return bookEditons;
    }

    public void setBookEditons(List<com.aem.geeks.core.helper.NastedHalper> bookEditons) {
